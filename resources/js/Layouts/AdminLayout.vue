...
const navigation = [
    { name: 'Dashboard', href: 'admin.dashboard', current: 'admin.dashboard' },
    { name: 'Evenimente', href: 'admin.events.index', current: 'admin.events.*' },
    { name: 'Precomenzi', href: 'admin.preorders.index', current: 'admin.preorders.*' },
];
</script>
